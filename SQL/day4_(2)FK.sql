...
-- 해결방법1) 자식테이블 삭제 2) FK제약조건 삭제

-- 참조관계 오류 발생하는 사례(무결성 제약 조건 위배)
-- ORA-02291: integrity constraint (C##IDEV.SYS_C007363) violated - parent key not found
...
INSERT INTO TBL_SCORE VALUES (8, '2025004', '영어', 90, '박영어', '2022_02');
INSERT INTO TBL_SCORE VALUES (9, '2025005', '영어', 95, '박영어', '2022_02');
commit;
