...
SELECT TO_CHAR (SYSDATE, 'yyyy-mm-dd hh24 mi:am') from dual; -- 12시 기준
-- to_char() 함수 패턴은 위의 포맷에서 년도, 월, 일, 시, 분, 초 각각을 출력도 가능
...
-- '2025-08-04' 과 '2025-12-25' 의 차이
 ...
 from dual; -- 시간이 0시 기준
  ...
  select TO_DATE('2025-12-25', 'yyyy-mm-dd') - TRUNC(SYSDATE)
 from dual;
...
-- 2) 날짜 사이의 차이를 구할 때 : 개월 수 (월 값만 가지고 뺄셈으로 못함.)
