...
INSERT INTO 
	TBL_MEMBER 			 
VALUES TO_DATE('2023-10-24', 'yyyy-mm-dd')
...
-- BETWEEN 실험용
  SELECT * FROM TBL_MEMBER
  WHERE JOIN_DATE BETWEEN '2023-01-01' AND '2023-12-31'    -- 날짜 타입으로 변환 후 
  ORDER BY JOIN_DATE ;
...
INSERT INTO TBL_MEMBER VALUES (12,'홍길동2','gdHong2@naver.com','2025/01/04');
INSERT INTO TBL_MEMBER VALUES (13,'홍길동3','gdHong3@naver.com','01/04/2025'); -- 오류
INSERT INTO TBL_MEMBER VALUES (13,'홍길동3','gdHong3@naver.com','04-01-25'); -- yy-mm-dd (1904년)
INSERT INTO TBL_MEMBER VALUES (14,'홍길동4','gdHong4@naver.com','25/01/04'); --1925년
...
-- 회원들 가입날짜에서 가입시간을 추출
SELECT NAME, to_char(join_date,'hh24:mi:ss') AS "jtime"   
FROM TBL_MEMBER 
