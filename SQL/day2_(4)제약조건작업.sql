...
USER_CONSTRAINTS , USER_CONS_COLUMNS 테이블들을 ✅ '딕셔너리 뷰'  라고 부름
*/
...
-- 컬럼 레벨
CREATE TABLE tbl_javadict3 (
		idx number(10) , CONSTRAINT pk_javadict3_idx PRIMARY KEY (idx),
		english varchar2(100) NOT NULL, CONSTRAINT uq_javadict3_english UNIQUE (english),  
		korean varchar2(500) , CONSTRAINT nn_javadict3_kor CHECK (KOREAN IS NOT NULL), 
		step char(1),  CONSTRAINT chk_javadict3_step CHECK (step BETWEEN '1' AND '3')
);
